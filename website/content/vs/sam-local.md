...
description = "How fakecloud compares to AWS SAM Local. Scope difference: SAM Local runs Lambda + limited API Gateway; fakecloud runs 33 services with real cross-service wiring."
template = "page.html"
+++
...
fakecloud runs Lambda the same way — real runtime containers, 23 runtimes supported — and also runs 22 other AWS services end-to-end.
